    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-black   ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                    <a class="nav-link text-light" href="#">Places to stay</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link text-light" href="#">Experiences</a>
                    </li>
                    <li class="nav-item">
...
<ul class="navbar-nav navbar-right">
                    <li class="nav-item">
                        <a class="nav-link text-light" href="#">Become a host</a>
                    </li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item text-light text-dark" href="#">Host your home</a></li>
                    <li><a class="dropdown-item text-light text-dark" href="#">Host an experience</a></li>
                    <li><a class="dropdown-item text-light text-dark" href="#">Help</a></li>
                </ul>
        </div>
        </nav>
        </div>
